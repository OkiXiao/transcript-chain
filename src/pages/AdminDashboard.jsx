...
function AdminDashboard() {
    ...
    useEffect(() => {
        if (accessStatus === 'ok') fetchWhitelist();
    }, [accessStatus, fetchWhitelist]);
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'var(--space-2xl)', flexWrap: 'wrap', gap: 'var(--space-md)' }}>
                <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 6 }}>
                        ...
                        <div>
                            ...
                            <p style={{ color: 'var(--text-muted)', fontSize: 'var(--font-sm)', margin: 0 }}>Kelola whitelist Institusi dan HR</p>
                        </div>
                    </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <button className="btn btn-secondary" style={{ fontSize: 'var(--font-xs)', padding: '6px 12px' }}
                        onClick={fetchWhitelist} disabled={listLoading}>
                    ...
                    <form onSubmit={handleAdd} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
                        ...
                        <div className="form-group" style={{ marginBottom: 0 }}>
                            ...
                            <input type="text" className="form-input"
                                placeholder={activeTab === 'schools' ? 'Nama Institusi (opsional)' : 'Nama Perusahaan (opsional)'}
